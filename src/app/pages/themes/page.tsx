...
export default function Themes() {
    return (
        <>
            <ImageHeader banner={banner} headerTitle="Thema&apos;s Geïntegreerde Wijkzorg" />
            ...
            <h2>GWZ en Advanced Care Planning (ACP)</h2>
            <p>Binnen GWZ is veel aandacht voor ACP, het anticiperen op toekomstige zorgsituaties. Dit betreft de wensen en voorkeuren van de cliënt en de mantelzorger(s) en wat de uitgebreide mogelijkheden zijn die het GWZ-team kan bieden om hieraan een bijdrage te leveren.</p>

            <h2>GWZ en Zorgtechnologie </h2>
            <p>Ergotherapie is een logische partner om te kijken naar optimale technologische oplossingen waardoor het dagelijks handelen mogelijk blijft. Binnen de fysiotherapie wordt steeds meer gebruik gemaakt van exergames, die de gezondheid of de balans kunnen bevorderen of kwetsbaarheid verminderen.</p>

            <h2>GWZ en grenzen aan de zorg</h2>
            <p>Bij geïntegreerde wijkzorgteams kunnen vragen neergelegd worden rondom de houdbaarheid van de thuissituatie om uitsluitsel te geven over de vraag: kan het thuis nog of kan het thuis weer en zo ja, wat is er nodig om de thuissituatie te handhaven? </p>

            <h2>GWZ en zorg buitenshuis </h2>
            <p>In veel gevallen waarin een cliënt tijdelijk niet thuis kan zijn (bijvoorbeeld door overbelasting van de mantelzorger of tijdelijke beperking zoals een gebroken heup of door afnemende functionele vaardigheden) kan het nodig zijn dat een cliënt tijdelijk uit huis wordt geplaatst, bijvoorbeeld naar een voorziening in de wijk van de cliënt. Deze tussentijdse oplossing wordt in Nederland op verschillende plekken en manieren aangeboden. Daarbij wordt de zorg vaak geleverd door de zorginstantie die de tijdelijke plek aanbiedt. Het is beter voor de cliënt wanneer op deze tussentijdse zorglocatie de zorg wordt voortgezet door hetzelfde GWZ-team dat de zorg in de thuissituatie heeft geleverd, of waarvan duidelijk is dat dit team de zorg weer gaat leveren, na thuiskomst van de cliënt. De betrokken (in)formele zorgverleners in de 1ste lijn beschikken over de meest actuele, relevante en brede informatie over de cliënt en de thuissituatie. </p>
        </>
    )
}
